...
public class csvParser extends Parser {
	...
	public static final int
		RULE_file = 0, RULE_header_row = 1, RULE_row = 2, RULE_field = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"file", "header_row", "row", "field"
		};
	}
	...
	public static class Header_rowContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof csvListener ) ((csvListener)listener).enterHeader_row(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof csvListener ) ((csvListener)listener).exitHeader_row(this);
		}
	}
