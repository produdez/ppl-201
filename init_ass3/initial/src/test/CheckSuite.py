...
class CheckSuite(unittest.TestCase):
    ...
    def test_number_26(self):
        ...
        raw_input= """Function: recur Parameter: x,y Body: x=2.2; recur(y,x); EndBody."""
        input = Program([FuncDecl(Id('recur'), [VarDecl(Id('x'), [], None), VarDecl(Id('y'), [], None)], ([], [Assign(Id('x'), FloatLiteral(2.2)), CallStmt(Id('recur'), [Id('y'), Id('x')])]))])
    ...
    def test_number_61(self):
        ...
        expect = str(TypeCannotBeInferred(Assign(ArrayCell(Id('a'), [IntLiteral(5)]), IntLiteral(2))))
    ...
    def test_number_65(self):
        """nested funcall 2"""
        raw_input= """Function: f Parameter: x Body:  x = 5; Return float_of_int(x); EndBody. Function: main Parameter: x Body: Return f(main(f(main(2.5))));  EndBody. Function: test Parameter: x Body: x = f(main(x)) - x; EndBody."""
        input = Program([FuncDecl(Id('f'), [VarDecl(Id('x'), [], None)], ([], [Assign(Id('x'), IntLiteral(5)), Return(CallExpr(Id('float_of_int'), [Id('x')]))])), FuncDecl(Id('main'), [VarDecl(Id('x'), [], None)], ([], [Return(CallExpr(Id('f'), [CallExpr(Id('main'), [CallExpr(Id('f'), [CallExpr(Id('main'), [FloatLiteral(2.5)])])])]))])), FuncDecl(Id('test'), [VarDecl(Id('x'), [], None)], ([], [Assign(Id('x'), BinaryOp('-', CallExpr(Id('f'), [CallExpr(Id('main'), [Id('x')])]), Id('x')))]))])
    ...
    def test_number_103(self):
        """infering array elem to array"""
        raw_input= """Function: main Body: Var: a[2]; a[1] = {{1,2},{3,4}}; a[2][3][4] = 5; a[2][3] = 6; EndBody."""
        input = Program([FuncDecl(Id('main'), [], ([VarDecl(Id('a'), [2], None)], [Assign(ArrayCell(Id('a'), [IntLiteral(1)]), ArrayLiteral([ArrayLiteral([IntLiteral(1), IntLiteral(2)]), ArrayLiteral([IntLiteral(3), IntLiteral(4)])])), Assign(ArrayCell(Id('a'), [IntLiteral(2), IntLiteral(3), IntLiteral(4)]), IntLiteral(5)), Assign(ArrayCell(Id('a'), [IntLiteral(2), IntLiteral(3)]), IntLiteral(6))]))])
        expect = str()
    ...
    def test_number_108(self):
        ...
        expect = str(TypeCannotBeInferred(Assign(ArrayCell(Id('a'), [IntLiteral(2), IntLiteral(3)]), IntLiteral(5))))
    ...
    def test_number_113(self):
        ...
        expect = str(TypeCannotBeInferred(Assign(Id('b'), BinaryOp('+', Id('a'), CallExpr(Id('main'), [Id('arr')])))))
    ...
    def test_number_114(self):
        ...
        expect = str(TypeCannotBeInferred(Assign(Id('b'), BinaryOp('+', CallExpr(Id('main'), [Id('arr')]), IntLiteral(2)))))
