// Generated from e:\Messy\Downloads\BKIT ASSIGN\test_antlr\dot_grammar\dot.g4 by ANTLR 4.8
...
public class dotParser extends Parser {
	...
	public static final int
		...
		ID=17, STRING=18, HTML_STRING=19, NUMBER=20;
	public static final int
	...
	public final GraphContext graph() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ID) | (1L << STRING) | (1L << HTML_STRING) | (1L << NUMBER))) != 0)) {
				{
				setState(32);
				id();
				}
	...
	public final Stmt_listContext stmt_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << GRAPH) | (1L << NODE) | (1L << EDGE) | (1L << SUBGRAPH) | (1L << ID) | (1L << STRING) | (1L << HTML_STRING) | (1L << NUMBER))) != 0)) {
				{
				{
				setState(39);
				stmt();
	...
	public final A_listContext a_list() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ID) | (1L << STRING) | (1L << HTML_STRING) | (1L << NUMBER))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
