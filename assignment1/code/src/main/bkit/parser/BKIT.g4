...
//     | expression2;
// expression2: 
//     LEFT_PAREN expression RIGHT_PAREN #paren_expr
//     | function_call # func_expr
//     | expression index_operator+ # element_expr
//     | <assoc=right> sign_op expression2 # sign_expr
//     | <assoc=right> negation_op expression2 # not_expr
//     | expression2 multiplying_op expression2 # mul_expr
//     | expression2 adding_op expression2 # add_expr
//     | expression2 logical_op expression2 # logic_expr
//     | variable # var_expr
//     | literal # lit_expr
//     ; 
