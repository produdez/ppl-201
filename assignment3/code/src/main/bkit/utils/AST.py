...
@dataclass
class FuncDecl(Decl):
    #TODO: note that func is equivalent if they have same name + input
    name: Id
    param: List[VarDecl]
...
class BinaryOp(Expr):
    ...
    def __str__(self):
        if printraw(self): return printraw(self)
        return "BinaryOp(" + fstr(self.op) + "," + str(self.left) + "," + str(self.right) + ")"
...
class UnaryOp(Expr):
    ...
    def __str__(self):
        if printraw(self): return printraw(self)
        return "UnaryOp(" + fstr(self.op) + "," + str(self.body) + ")"
...
class StringLiteral(Literal):
    ...
    def __str__(self):
        if printraw(self): return printraw(self)
        return "StringLiteral(" + repr(self.value) + ")"
