...
Symbol("float_to_int",FunctionType([Symbol(None,IntType(),Parameter())],FloatType())),
...
Symbol("printStrLn",FunctionType([Symbol(None,StringType(),Parameter())],VoidType()))]
    ...
    def visitCallExpr(self, ast: CallExpr, params):
        ...
        #infer return type
        Helper.infer(func_sym,infer_type)
        ...
        for param_sym,arg_ast in zip(param_sym_list,ast.param):
            ...
            p_unknown = ptype == Unknown() or Helper.isUnknownArray(ptype)
    ...
    def visitReturn(self, ast:Return, env):
        ...
        expr_type = ast.expr.accept(self,(env,None,ast)) if ast.expr else VoidType() #NOTE: infer expression
    ...
    def visitCallStmt(self, ast:CallStmt, env):
        ...
        for param_sym,arg_ast in zip(param_sym_list,ast.param):
            ...
            p_unknown = ptype == Unknown() or Helper.isUnknownArray(ptype) #param can only be unknown, not unknown array.
            a_unknown = atype == Unknown() or Helper.isUnknownArray(atype)
